# Quick fix - run this to recreate everything with truncated sequences
import random, math
...
for epoch in range(1,6):
    ...
    tax_acc = evaluate(val_loader)
    print(f"Epoch {epoch} | Train loss {avg:.4f} | Val tax acc {tax_acc:.3f}")

# Save model
torch.save({'model_state_dict': model.state_dict(), 'tokenizer_vocab': tokenizer.vocab}, 'multitask_model_16s.pth')
print("Saved model to multitask_model_16s.pth")